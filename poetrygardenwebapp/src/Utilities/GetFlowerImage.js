...
const getFlowerImage = (placeholder) => {
    if (placeholder === "Flower1.png")
        return Flower1; //
    if (placeholder === "Flower2.png")
        return Flower2;
    if (placeholder === "Flower3.png")
        return Flower3;
    if (placeholder === "Flower4.png")
        return Flower4;
    if (placeholder === "Flower5.png")
        return Flower5;
    if (placeholder === "Flower6.png")
        return Flower6;
    if (placeholder === "Flower7.png")
        return Flower7;
    if (placeholder === "Flower8.png")
        return Flower8;
    if (placeholder === "Flower9.png")
        return Flower9;
    if (placeholder === "Flower10.png")
        return Flower10;
    if (placeholder === "Flower11.png")
        return Flower11;
    if (placeholder === "Flower12.png")
        return Flower12;

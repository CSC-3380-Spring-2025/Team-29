// Enhanced ProfileCard.jsx pink and green theme
...
const ProfileCard = () => {
  ...
  const profileFields = [
    { label: "Bio", value: bio, temp: tempBio, setTemp: setTempBio, type: "textarea" },
    { label: "Email", value: email, temp: tempEmail, setTemp: setTempEmail },
    { label: "Location", value: location, temp: tempLocation, setTemp: setTempLocation },
    { label: "Interests", value: interests, temp: tempInterests, setTemp: setTempInterests },
    { label: "Language", value: language, temp: tempLanguage, setTemp: setTempLanguage },
    { label: "Nickname", value: nickname, temp: tempNickname, setTemp: setTempNickname },
  ];
    ...
    <AnimatePresence>
      {showCard && (
        <motion.div
          ...
          className="relative max-w-2xl mx-auto bg-gradient-to-br from-pink-100 via-white to-green-100 shadow-xl rounded-3xl p-10 space-y-6 border border-green-200"
        >
          {/* Profile Header */}
          <h1 className="text-5xl font-extrabold text-green-700 text-center mb-6">Profile</h1>
          ...
          <div className="flex flex-col space-y-6">
            {profileFields.map(({ label, value, temp, setTemp, type }) => (
              <div key={label} className="bg-white rounded-lg p-3 shadow-sm">
                <h3 className="font-semibold text-green-800 mb-1 text-lg">{label}:</h3>
                {editing ? (
                  type === "textarea" ? (
                    <textarea
                  ...
                  <p className="text-gray-600 text-sm bg-pink-50 px-2 py-1 rounded shadow-inner">
                    {value}
                  </p>
                )}
              </div>
          ...
          {editing && (
            <div className="flex justify-end space-x-2 pt-4">
              {!isUsernameValid && (
                <p className="text-red-500 text-xs absolute bottom-4 left-6">
